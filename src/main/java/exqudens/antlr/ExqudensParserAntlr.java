...
public interface ExqudensParserAntlr {
    ...
    default Entry<Map<List<String>, String>, Map<String, Map<String, String>>> parse(
            String text,
            String template,
        ...
        try {
            ...
            ParseTreeProcessor parseTreeProcessor = new ParseTreeProcessor() {};

            Map<List<String>, String> map = parseTreeProcessor.toMap(parseTree, ruleNames, ruleConfigMap.keySet());
